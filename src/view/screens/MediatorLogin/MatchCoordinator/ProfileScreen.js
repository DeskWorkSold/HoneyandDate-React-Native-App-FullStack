import { Dimensions, Image, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, ToastAndroid, TouchableOpacity, View } from 'react-native'
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <View style={{ marginTop: 20 }}>
                                <View style={styles.NumberInput}>
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('PaymentType' , {titel:'Payment Type'})}>
                                        <Path width={15} height={15} />
                                    </TouchableOpacity>
                                </View>
                            </View>
